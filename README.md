...
```text
to-java.xsl              51976  33.47%
classes.xsl              48356  31.14%
set-locators.xsl         15038  9.68%
set-original-names.xsl   10239  6.59%
attrs.xsl                6802   4.38%
data.xsl                 6132   3.95%
anonymous-to-nested.xsl  5760   3.71%
package.xsl              5633   3.63%
tests.xsl                5359   3.45%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-07-13 at 20:15,
on Linux with 4 CPUs.
The total is 155295 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/29281308368
